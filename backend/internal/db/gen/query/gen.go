...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		WaitingList:    newWaitingList(db, opts...),
	}
}
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		WaitingList:    q.WaitingList.clone(db),
	}
}
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		WaitingList:    q.WaitingList.replaceDB(db),
	}
}

type queryCtx struct {
	GooseDbVersion IGooseDbVersionDo
	WaitingList    IWaitingListDo
}

func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		GooseDbVersion: q.GooseDbVersion.WithContext(ctx),
		WaitingList:    q.WaitingList.WithContext(ctx),
	}
}
